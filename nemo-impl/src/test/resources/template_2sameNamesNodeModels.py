...
def register_template_definition(contHost):
	data={
			"input":{
			  "user-id": "af4fc2be-e3f4-4388-a8ef-3aabae872f2b",
			  "nemo-statement": 
				"CREATE NodeModel sample_vnf VNFD file://github.com/nfvlabs/openmano/blob/master/openmano/scenarios/examples/complex; ConnectionPoint data_inside at VNFD:vnfd-interface; ConnectionPoint data_outside at VNFD:ge1;"
			}
		}
...
def register_template_definition2(contHost):
	data={
			"input":{
			  "user-id": "af4fc2be-e3f4-4388-a8ef-3aabae872f2b",
			  "nemo-statement": 
				"CREATE NodeModel sample_vnf VNFD file://github.com/nfvlabs/openmano/blob/master/openmano/scenarios/examples/complex;"
			}
		}
	post(LANGUAGE_INTENT % contHost, data)
...
def add_dmz_node(contHost):
	data={
			"input":{				 
				  "user-id": "af4fc2be-e3f4-4388-a8ef-3aabae872f2b",
				  "nemo-statement":
					"CREATE NodeModel dmz; Node sa2 Type sample_vnf; Node sha2 Type shaper_vnf; ConnectionPoint inside at VNFD:q1; Connection c1 Type p2p Endnodes inside, sa2.data_inside ; Connection c2 Type p2p Endnodes sha2.a, sa2.data_outside; "
				}
		}
	post(LANGUAGE_INTENT % contHost,data)
...
def add_internet_node(contHost):
	data={
			"input":{				 
				  "user-id": "14ce424a-3e50-4a2a-ad5c-b29845158c8b",
				  "nemo-statement": "CREATE Node vm1 Type dmz;"
				}
		}
	post(LANGUAGE_INTENT % contHost,data)
