...
def register_template_definition(contHost):
	data={
			"input":{
			  "user-id": "af4fc2be-e3f4-4388-a8ef-3aabae872f2b",
			  "nemo-statement": 
				"CREATE NodeModel sample_vnf Property string : vnfd-interface VNFD file://github.com/nfvlabs/openmano/blob/master/openmano/scenarios/examples/complex; ConnectionPoint data_inside at VNFD:vnfd-interface; ConnectionPoint data_inside at VNFD:ge1;"
			}
		}
...
def add_internet_node(contHost):
	data={
			"input":{				 
				  "user-id": "14ce424a-3e50-4a2a-ad5c-b29845158c8b",
				  "nemo-statement": "CREATE NodeModel sample_vnf Property string : vnfd-int VNFD file://github.com/nfvlabs/openmano/blob/master/openmano/scenarios/examples/complex.yaml; ConnectionPoint output1 at VNFD:a1; "
				}
		}
	post(LANGUAGE_INTENT % contHost,data)
