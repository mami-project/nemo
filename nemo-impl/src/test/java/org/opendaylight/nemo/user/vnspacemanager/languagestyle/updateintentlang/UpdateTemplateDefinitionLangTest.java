...
public class UpdateTemplateDefinitionLangTest extends TestCase {
    ...
    private Field field_abstractConnectionPoints;      
    private Field field;
    ...
    public void setUp() throws Exception {
        ...
        field_abstractConnectionPoints = class1.getDeclaredField("abstractConnectionPoints");
        ...
        field_abstractConnectionPoints.setAccessible(true);
    ...
    public void testTemplateDefinitionLang() throws Exception {
        ...
        ConnectionPointName connectionPointName = mock(ConnectionPointName.class);
        ...
        Map<ConnectionPointName, AbstractConnectionPoint> abstractConnectionPoints = new HashMap<ConnectionPointName, AbstractConnectionPoint>();
        String vnfUri = new String ("https://test");
        ...
        abstractConnectionPoints.put(connectionPointName,abstractConnectionPoint);
        ...
        when(updateTemplateDefinition.checkTemplateDefinition(any(UserId.class),any(TemplateDefinition.class)))
                ...
                .thenReturn("2")
                .thenReturn("3");
        Assert.assertTrue(updateTemplateDefinitionLang.templateDefinitionLang(userId, templateName, parameters, vnfUri).equals("1"));
        parameters.clear();
        ...
        field_abstractConnectionPoints.set(updateTemplateDefinitionLang, abstractConnectionPoints);
        Assert.assertTrue(updateTemplateDefinitionLang.templateDefinitionLang(userId, templateName, parameters, vnfUri).equals("2"));
        parameters.clear();
        parameters.put(value, NEMOConstants.range);
        Assert.assertTrue(updateTemplateDefinitionLang.templateDefinitionLang(userId, templateName, parameters, vnfUri).equals("3"));
    ...
    public void testCreateAbstractNode() throws Exception {
        ...
        when(physicalHostMap.containsKey(any(PhysicalHostName.class)))
                .thenReturn(false)
                .thenReturn(true);
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractNode(userId, name, type, subnodes, propertyList).equals("The host " + name + " is not exist in physical network."));
        ...
        //test nodes empty
        field_abstractNodes.set(updateTemplateDefinitionLang, abstractNodes);
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractNode(userId, name, type, subnodes, propertyList).equals("There are no nodes."));
        //nodes not empty propertyList empty
        abstractNodes.put(nodeName, abstractNode);
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractNode(userId, name, type, subnodes, propertyList) == null);
    ...
    public void testCreateAbstractConnection() throws Exception {
        ...
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractConnection(userId, name, type, endnodes, propertyList).equals("There are nodes exist."));
        //abstractNodes not empty
        field_abstractNodes.set(updateTemplateDefinitionLang, abstractNodes);
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractConnection(userId, name, type, endnodes, propertyList).equals("The endnode " + endNode + " is not exit."));
        abstractNodes.clear();
        abstractNodes.put(new NodeName(endNode), abstractNode);
        when(abstractNode.getNodeId()).thenReturn(nodeId);
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractConnection(userId, name, type, endnodes, propertyList) == null);
...
//        System.out.println("split" + conditionName.split(NEMOConstants.comma)[0] + "+" + conditionName.split(NEMOConstants.comma)[2]);
 ...
 @Test
    public void testCreateAbstractConnectionPoint() throws Exception {
        String name = new String("name");
        String extInterfaceName = new String("extInterfaceName");


        //test extInterfaceName null
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractConnectionPoint(name, null) == null);
        Assert.assertTrue(updateTemplateDefinitionLang.createAbstractConnectionPoint(name, extInterfaceName) == null);
        //test extInterfaceName not null
