...
public class UpdateConnectionLang {
    ...
    private String createConnection(UserId userId, String connectionname, String connectiontype, List<String> endnodes, LinkedHashMap<String, LinkedHashMap<String,String>> propertyList){
        ...
        if (!endnodes.isEmpty()){
            ...
            for (String endNodeName : endnodes){
                if (tenantManage.getObjectId(userId,endNodeName)!=null){
                    Long order = 0L;
                    ObjectId endNodeId = new ObjectId (tenantManage.getObjectId(userId,endNodeName));
                    EndNodeBuilder endNodeBuilder = new EndNodeBuilder();
                    endNodeBuilder.setKey(new EndNodeKey(endNodeId))
                                  .setNodeId(endNodeId)
                                  .setOrder(order);
                    order++;
                    ...
                    return "The end node " + endNodeName + " does not exist.";
                }
            }
